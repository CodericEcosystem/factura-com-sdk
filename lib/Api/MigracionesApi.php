...
/**
 * MigracionesApi Class Doc Comment
 *
 * @category Class
 * @package  FacturaCom\FacturaComSdk
 * @author   Swagger Codegen team
...
class MigracionesApi
{
    ...
    /**
     * Operation apiMigrator704e9db88fc34fa38ec0424b47ac0072ViewGet
     *
     ...
     * @return void
     */
    public function apiMigrator704e9db88fc34fa38ec0424b47ac0072ViewGet($content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        $this->apiMigrator704e9db88fc34fa38ec0424b47ac0072ViewGetWithHttpInfo($content_type, $f_plugin, $f_api_key, $f_secret_key);
    }

    /**
     * Operation apiMigrator704e9db88fc34fa38ec0424b47ac0072ViewGetWithHttpInfo
     *
     * Consultar una migracion en especifico
     *
     ...
     */
    public function apiMigrator704e9db88fc34fa38ec0424b47ac0072ViewGetWithHttpInfo($content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        $returnType = '';
        $request = $this->apiMigrator704e9db88fc34fa38ec0424b47ac0072ViewGetRequest($content_type, $f_plugin, $f_api_key, $f_secret_key);
    ...
    /**
     * Operation apiMigrator704e9db88fc34fa38ec0424b47ac0072ViewGetAsync
     *
     * Consultar una migracion en especifico
     *
     * @param  string $content_type (optional)
     ...
     */
    public function apiMigrator704e9db88fc34fa38ec0424b47ac0072ViewGetAsync($content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        return $this->apiMigrator704e9db88fc34fa38ec0424b47ac0072ViewGetAsyncWithHttpInfo($content_type, $f_plugin, $f_api_key, $f_secret_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiMigrator704e9db88fc34fa38ec0424b47ac0072ViewGetAsyncWithHttpInfo
     *
     * Consultar una migracion en especifico
     *
     * @param  string $content_type (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiMigrator704e9db88fc34fa38ec0424b47ac0072ViewGetAsyncWithHttpInfo($content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        $returnType = '';
        $request = $this->apiMigrator704e9db88fc34fa38ec0424b47ac0072ViewGetRequest($content_type, $f_plugin, $f_api_key, $f_secret_key);
    ...
    /**
     * Create request for operation 'apiMigrator704e9db88fc34fa38ec0424b47ac0072ViewGet'
     *
     * @param  string $content_type (optional)
     * @param  string $f_plugin (optional)
     * @param  string $f_api_key (optional)
     ...
     */
    protected function apiMigrator704e9db88fc34fa38ec0424b47ac0072ViewGetRequest($content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {

        $resourcePath = '/api/migrator/704e9db8-8fc3-4fa3-8ec0-424b47ac0072/view';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiMigratorCreatePost
     *
     ...
     * @return void
     */
    public function apiMigratorCreatePost($body = null, $content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        $this->apiMigratorCreatePostWithHttpInfo($body, $content_type, $f_plugin, $f_api_key, $f_secret_key);
    }

    /**
     * Operation apiMigratorCreatePostWithHttpInfo
     *
     * Crear nueva migración de CFDIs
     *
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiMigratorCreatePostWithHttpInfo($body = null, $content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        $returnType = '';
        $request = $this->apiMigratorCreatePostRequest($body, $content_type, $f_plugin, $f_api_key, $f_secret_key);
    ...
    /**
     * Operation apiMigratorCreatePostAsync
     *
     * Crear nueva migración de CFDIs
     *
     * @param  string $body (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiMigratorCreatePostAsync($body = null, $content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        return $this->apiMigratorCreatePostAsyncWithHttpInfo($body, $content_type, $f_plugin, $f_api_key, $f_secret_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiMigratorCreatePostAsyncWithHttpInfo
     *
     * Crear nueva migración de CFDIs
     *
     * @param  string $body (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiMigratorCreatePostAsyncWithHttpInfo($body = null, $content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        $returnType = '';
        $request = $this->apiMigratorCreatePostRequest($body, $content_type, $f_plugin, $f_api_key, $f_secret_key);
    ...
    /**
     * Create request for operation 'apiMigratorCreatePost'
     *
     * @param  string $body (optional)
     * @param  string $content_type (optional)
     * @param  string $f_plugin (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiMigratorCreatePostRequest($body = null, $content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {

        $resourcePath = '/api/migrator/create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return void
     */
    public function apiMigratorListGet($content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        $this->apiMigratorListGetWithHttpInfo($content_type, $f_plugin, $f_api_key, $f_secret_key);
    }

    /**
     * Operation apiMigratorListGetWithHttpInfo
     *
     * Consultar todas las migraciones
     *
     * @param  string $content_type (optional)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiMigratorListGetWithHttpInfo($content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        $returnType = '';
        $request = $this->apiMigratorListGetRequest($content_type, $f_plugin, $f_api_key, $f_secret_key);
    ...
    /**
     * Operation apiMigratorListGetAsync
     *
     * Consultar todas las migraciones
     *
     * @param  string $content_type (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiMigratorListGetAsync($content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        return $this->apiMigratorListGetAsyncWithHttpInfo($content_type, $f_plugin, $f_api_key, $f_secret_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiMigratorListGetAsyncWithHttpInfo
     *
     * Consultar todas las migraciones
     *
     * @param  string $content_type (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiMigratorListGetAsyncWithHttpInfo($content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        $returnType = '';
        $request = $this->apiMigratorListGetRequest($content_type, $f_plugin, $f_api_key, $f_secret_key);
    ...
    /**
     * Create request for operation 'apiMigratorListGet'
     *
     * @param  string $content_type (optional)
     * @param  string $f_plugin (optional)
     * @param  string $f_api_key (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiMigratorListGetRequest($content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {

        $resourcePath = '/api/migrator/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
