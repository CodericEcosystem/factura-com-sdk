...
/**
 * ProductosApi Class Doc Comment
 *
 * @category Class
 * @package  FacturaCom\FacturaComSdk
 * @author   Swagger Codegen team
...
class ProductosApi
{
    ...
    /**
     * Operation apiV3ProductsCreateGet
     *
     * Crear productos
     *
     ...
     * @return void
     */
    public function apiV3ProductsCreateGet($content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        $this->apiV3ProductsCreateGetWithHttpInfo($content_type, $f_plugin, $f_api_key, $f_secret_key);
    }

    /**
     * Operation apiV3ProductsCreateGetWithHttpInfo
     *
     * Crear productos
     *
     ...
     */
    public function apiV3ProductsCreateGetWithHttpInfo($content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        $returnType = '';
        $request = $this->apiV3ProductsCreateGetRequest($content_type, $f_plugin, $f_api_key, $f_secret_key);
    ...
    /**
     * Operation apiV3ProductsCreateGetAsync
     *
     * Crear productos
     *
     * @param  string $content_type (optional)
     ...
     */
    public function apiV3ProductsCreateGetAsync($content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        return $this->apiV3ProductsCreateGetAsyncWithHttpInfo($content_type, $f_plugin, $f_api_key, $f_secret_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiV3ProductsCreateGetAsyncWithHttpInfo
     *
     * Crear productos
     *
     * @param  string $content_type (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV3ProductsCreateGetAsyncWithHttpInfo($content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        $returnType = '';
        $request = $this->apiV3ProductsCreateGetRequest($content_type, $f_plugin, $f_api_key, $f_secret_key);
    ...
    /**
     * Create request for operation 'apiV3ProductsCreateGet'
     *
     * @param  string $content_type (optional)
     * @param  string $f_plugin (optional)
     * @param  string $f_api_key (optional)
     ...
     */
    protected function apiV3ProductsCreateGetRequest($content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {

        $resourcePath = '/api/v3/products/create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiV3ProductsCreatePost
     *
     * Listar productos
     *
     ...
     * @return void
     */
    public function apiV3ProductsCreatePost($body = null, $content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        $this->apiV3ProductsCreatePostWithHttpInfo($body, $content_type, $f_plugin, $f_api_key, $f_secret_key);
    }

    /**
     * Operation apiV3ProductsCreatePostWithHttpInfo
     *
     * Listar productos
     *
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV3ProductsCreatePostWithHttpInfo($body = null, $content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        $returnType = '';
        $request = $this->apiV3ProductsCreatePostRequest($body, $content_type, $f_plugin, $f_api_key, $f_secret_key);
    ...
    /**
     * Operation apiV3ProductsCreatePostAsync
     *
     * Listar productos
     *
     * @param  string $body (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV3ProductsCreatePostAsync($body = null, $content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        return $this->apiV3ProductsCreatePostAsyncWithHttpInfo($body, $content_type, $f_plugin, $f_api_key, $f_secret_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiV3ProductsCreatePostAsyncWithHttpInfo
     *
     * Listar productos
     *
     * @param  string $body (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV3ProductsCreatePostAsyncWithHttpInfo($body = null, $content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
        $returnType = '';
        $request = $this->apiV3ProductsCreatePostRequest($body, $content_type, $f_plugin, $f_api_key, $f_secret_key);
    ...
    /**
     * Create request for operation 'apiV3ProductsCreatePost'
     *
     * @param  string $body (optional)
     * @param  string $content_type (optional)
     * @param  string $f_plugin (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiV3ProductsCreatePostRequest($body = null, $content_type = null, $f_plugin = null, $f_api_key = null, $f_secret_key = null)
    {
